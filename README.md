...
| Folder | Deskripsi |
|:-------|:-----------|
| **TUGAS1/** | Membuat halaman web dasar berisi teks, gambar, tabel, dan hyperlink. Fokus pada struktur HTML. |
| **TUGAS2/** | Menambahkan desain tampilan menggunakan **CSS eksternal** (warna, layout, font, margin, padding). |
| **TUGAS3/latvarjs/** | Latihan **JavaScript dasar**, seperti variabel, operator, dan output ke halaman HTML. |
